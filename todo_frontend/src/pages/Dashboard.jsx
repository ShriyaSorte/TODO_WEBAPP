...
import profileImg from "../assets/profile_ss.jpg";
          ...
          <ul className="nav flex-column">
            <li className="nav-item mb-2">
              <Link
                className={`nav-link d-flex align-items-center ${
                  selected === "dashboard" ? "bg-white text-dark" : "text-white"
                } p-2 rounded`}
                to="/dashboard"
            ...
            <li className="nav-item mb-2">
              <Link
                ...
                onClick={() => handleSelect("vital-task")}
              >
            ...
            <li className="nav-item mb-2">
              <Link
                className={`nav-link d-flex align-items-center ${
                  selected === "my-task" ? "bg-white text-dark" : "text-white"
                } p-2 rounded`}
                to="/dashboard/my-task"
                onClick={() => handleSelect("my-task")}
              >
            ...
            <li className="nav-item mb-2">
              <Link
                ...
                onClick={() => handleSelect("task-categories")}
              >
            ...
            <li className="nav-item mb-2">
              <Link
                className={`nav-link d-flex align-items-center ${
                  selected === "settings" ? "bg-white text-dark" : "text-white"
                } p-2 rounded`}
            ...
            <li className="nav-item mb-2">
              <Link
                className={`nav-link d-flex align-items-center ${
                  selected === "help" ? "bg-white text-dark" : "text-white"
                } p-2 rounded`}
                to="/dashboard/help"
